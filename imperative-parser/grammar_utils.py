...
def gen_grammar(name, nonterminals, indent=4):
    ...
    Args:
        ...
        nonterminals (List): A list of the nonterminals it's associated with
...
def trivial(name, nonterminals, indent=4, suffix=''):
    ...
    Args:
        name (String): A string representing the nonterminal name
        nonterminals (List): A list of strings representing the nonterminals it's linked to

    Named Args:
        indent (Int): 4 -- An int representing the amount of indentation in the file
        suffix (String): '' -- A string representing a suffix that should be added to the name of the function

    Returns:
        Func. A function with the provided name and a generated grammar docstring
    """
    def template(p):
        p[0] = p[1]
...
def trivial_from_registry(name, registry, indent=4, suffix=''):
    ...
    Args:
        name (String): A string representing the nonterminal name
        registry (Dict): A registry generated by the get_registry() function
